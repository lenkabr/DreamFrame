...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://dreamframe-film.brozmanova-lenka.chatgpt.site/og.png', width: 1200, height: 630, alt: 'Dreamframe — Every feeling has a film.' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Dreamframe — Every feeling has a film',
    description: 'One thoughtful movie recommendation, chosen for how you want to feel.',
    images: ['https://dreamframe-film.brozmanova-lenka.chatgpt.site/og.png'],
  },
};
